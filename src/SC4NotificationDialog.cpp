...
namespace
{
	...
	typedef bool(__cdecl* pfnCreateSC4GenericNotificationDialog)(const cIGZString& caption, const cIGZString& message);
	...
	void ShowGZCOMMessageBox(const cIGZString& message, const cIGZString& caption)
	{
		cISC4AppPtr pSC4App;
...
void SC4NotificationDialog::ShowDialog(const cIGZString& message, const cIGZString& caption)
{
