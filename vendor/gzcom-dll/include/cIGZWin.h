...
class cIGZWin : public cIGZUnknown
{
	public:
		...
		virtual intptr_t GetDrawContext() = 0;
		virtual intptr_t GetBufferToDrawTo() = 0;
		...
		virtual intptr_t GetAreaToDrawTo() = 0;

		virtual bool PrivateBuffer(bool unknown1) = 0;
		virtual intptr_t GetPrivateBuffer() = 0;

		virtual void GetFillColor(uint8_t& unknown1, uint8_t& unknown2, uint8_t& unknown3) = 0;
		virtual void SetFillColor(uint8_t unknown1, uint8_t unknown2, uint8_t unknown3) = 0;
		...
		virtual bool SetFillColor(cRZColor const& unknown1) = 0;
		virtual bool MakeFillColor(uint8_t unknown1, uint8_t unknown2, uint8_t unknown3) = 0;
		...
		virtual void SetShadeColor(cRZColor const& unknown1) = 0;
		virtual void GetShadeColor(cRZColor& unknown1) = 0;

		virtual bool GetParam(uint32_t unknown1, cIGZVariant** unknown2) = 0;
		virtual bool SetParam(uint32_t unknown1, cIGZVariant* unknown2) = 0;
